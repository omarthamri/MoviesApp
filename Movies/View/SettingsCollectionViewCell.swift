...
class SettingsCollectionViewCell: UICollectionViewCell {
    ...
    func setupConstraints() {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-20-[v0(\(frame.width / 1.3))]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":settingNameLbl]))
