...
class TvCategoryViewCell: UICollectionViewCell {
    ...
    func setupConstraints() {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[v0(150)]-3-[v1]|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":tvCategoryImg,"v1":tvCategoryTitle]))
